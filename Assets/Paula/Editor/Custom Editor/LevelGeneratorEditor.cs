...
{
    [CustomEditor(typeof(Assets.Scripts.Level_Generator.Generator.LevelGenerator))]
    public class LevelGeneratorEditor : UnityEditor.Editor
    {
        private Assets.Scripts.Level_Generator.Generator.LevelGenerator LevelGenerator;

        private void OnEnable()
        {
            LevelGenerator = (Assets.Scripts.Level_Generator.Generator.LevelGenerator) target;
        }
