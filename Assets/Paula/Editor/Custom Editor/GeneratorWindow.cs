...
namespace Assets.Editor.Custom_Editor
{
    public class GeneratorWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (levelGeneratorObj == null || levelGeneratorObj.GetComponent<Assets.Scripts.Level_Generator.Generator.LevelGenerator>() == null) return;
            ...
            var levelGenerator = levelGeneratorObj.GetComponent<Assets.Scripts.Level_Generator.Generator.LevelGenerator>();
